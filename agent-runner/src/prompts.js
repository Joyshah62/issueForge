...
1. Fetch the issue:
   ...
   (set header Authorization: Bearer ${ctx.github_token})
...
10. Get the default branch:
    ...
    Headers: Authorization: Bearer ${ctx.github_token}, Accept: application/vnd.github+json
11. Create the PR (draft):
    http_request POST https://api.github.com/repos/${ctx.repo_full_name}/pulls
    Headers: Authorization: Bearer ${ctx.github_token}, Accept: application/vnd.github+json, Content-Type: application/json
    Body: {
...
1. Trigger a deploy:
   ...
   Headers: Authorization: Bearer ${ctx.render_api_key || 'KEY'}
